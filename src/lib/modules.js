...
export const MODULES = [
  ...
  { page: 'LessonsLearned', label: 'Lessons Learned', group: 'Tools' },
  { page: 'TurnoverPackages', label: 'Turnover Packages', group: 'Tools' },
  { page: 'AuditRegister', label: 'Audit & CAPA', group: 'Tools' },
